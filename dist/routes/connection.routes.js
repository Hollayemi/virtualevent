...
router.patch('/:connectionId/respond', auth_1.protect, (0, auth_1.requireAccountType)('user'), (0, validate_1.validate)(validation_schemas_1.respondConnectionSchema), connectionController.respondToConnection);
